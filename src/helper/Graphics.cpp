...
Graphics* Graphics::Instance() {
  ...
  if (sInstance == NULL) sInstance = new Graphics();
...
Graphics::Graphics() { sInitialized = Init(); }
...
SDL_Texture* Graphics::LoadTexture(std::string path) {
  ...
  // Converting the surface into a texture to be able to render it using the
  // renderer
...
void Graphics::ClearBackBuffer() { SDL_RenderClear(mRenderer); }
...
void Graphics::Render() { SDL_RenderPresent(mRenderer); }
}  // namespace QuickSDL
