...
// By: Ather Omar                                               //
//--------------------------------------------------------------//
#include <QuickSDL/AudioManager.h>
//----------------------------------------------------------
// QuickSDL
//----------------------------------------------------------
namespace QuickSDL {
...
AudioManager::AudioManager() {
  ...
  // Initialize the SDL_mixer using 44.1 khz and 2 channels (change if needed)
  // and handle initialization errors
...
void AudioManager::PlayMusic(std::string filename, int loops) {
  // Play the Mix_Music* loaded in the AssetManager so that the file is not
  // reloaded every time
...
void AudioManager::PlaySFX(std::string filename, int loops, int channel) {
  // Play the Mix_Chunk* loaded in the AssetManager so that the file is not
  // reloaded every time
