...
class AnimatedTexture : public Texture {
 public:
  ...
  //-----------------------------------------------------------------------------------
  // ANIM_DIR enum - The way the animation sprites are arranged in the
  // spritesheet horizontal / vertical
  //------------------------------------------------------------------------------------
 ...
 private:
  ...
  // Used to keep track of how long the current animation frame has been on
  // screen
  ...
  int mFrameCount;
  // Stores current animation frame
  int mCurrentFrame;
  ...
  // Is set to true only if the wrap mode is once and the last frame of the
 ...
 public:
  ...
  // animationDirection - How the animation sprites are arranges in the
  // spritesheet
  //---------------------------------------------------------------------------------
  AnimatedTexture(std::string filename, int x, int y, int w, int h,
                  int frameCount, float animationSpeed, ANIM_DIR animationDir);
  ~AnimatedTexture();
  ...
  void Update();
  //---------------------------------------------------------------------------
  // Used to update the animation frames without looping the animation
  //---------------------------------------------------------------------------
  void IgnoreTimerUpdate();
  //---------------------------------------------------------------------------
